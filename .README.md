...
- you need to procure
  ...
  because I didn't see fit to add that bleeding package part of the shell
  environment. It's necessary if you want to edit the cabal file, which is done
  through [`./cabal.dh`](./cabal.dh).
