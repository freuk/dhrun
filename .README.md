...
assertion-based CI tests. It starts a list of processes, monitors the standard
...
one execution capability and its assertions are poor. It supports concurrency
and monitors streams online, however.
