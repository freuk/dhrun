...
- install 1.0.0 release: `nix-env -f https://github.com/freuk/dhrun/archive/1.0.0.tar.gz -iA dhrun`

- install bleeding edge: `nix-env -f https://github.com/freuk/dhrun.git -iA dhrun`
